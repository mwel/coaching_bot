...
\chapter{Implementierung}
    ...
    \section{main.py - Anmeldung, Updater, Dispatcher und Handler-Konfiguration} \label{main.py}
        ...
        \begin{lstlisting}[language=Python, caption={bot\/main.py - state machine, Conversation- \& Command Handler}\label{code: bot/main.py}]
def main() -> None:
    ...
    \section{Handler Funktionen} \label{Handler Functions}
...
def skip_bio(update: Update, context: CallbackContext) -> int:
    ...
    return states.GENDER
        ...
        \subsection{gender.py} \label{gender.py}
