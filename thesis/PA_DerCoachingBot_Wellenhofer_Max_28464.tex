...
%------------------ Präambel ---------------------------------------------------
\documentclass[envcountsame, envcountchap, deutsch, scrartcl]{i-studis} % scrartcl?
...
\usepackage{pythontex} % python interpreter
...
\backmatter
\bibliography{coaching_bot_group}						% Literaturverzeichnis (literatur.bib)
\appendix{appendix}
